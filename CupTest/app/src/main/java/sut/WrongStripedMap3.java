...
public class WrongStripedMap3<K, V> implements OurMap<K, V> {
    ...
    public WrongStripedMap3(int lockCount) {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        WrongStripedMap3<Integer, Integer> map = new WrongStripedMap3<>(4);
